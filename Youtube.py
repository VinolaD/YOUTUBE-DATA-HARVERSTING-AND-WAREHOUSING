...
def playlist_table(channel_name_s):
    ...
    db=client["Youtube_data"]
    coll1=db["channel_details"]
    for ch_data in coll1.find({"channel_information.Channel_Name":channel_name_s},{"_id":0,"playlist_information":1}):
...
def videos_table(channel_name_s):
        ...
        db=client["Youtube_data"]
        coll1=db["channel_details"]
        for ch_data in coll1.find({"video_information.Channel_Name":channel_name_s},{"_id":0,"video_information":1}):
